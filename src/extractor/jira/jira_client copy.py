...
#         """
#         Retorna lista de issues (dict) via /rest/api/3/search/jql.
...
#     project = app_cfg.get("default_project", "KAN")
#     jql = f'project = "{project}" AND issuetype in ("Func", "Epic", "Story", "Bug", "Sub-Bug") ORDER BY created DESC'
